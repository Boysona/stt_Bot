...
def send_welcome_message(message):
    ...
    bot_name = "STT Bot"  # Ama wax kasta oo aad ugu yeerto bot-ka
    text = (
        f"👋 Salom! {first_name} welcome to {bot_name}\n\n"
        "To transcribe for free:\n"
        "• Send me voice message\n"
        "• Send me audio file\n"
        "• Send me video\n\n"
        "I will transcribe and send it back to you. \n\n"
        "You can also use /lang to change the language at any time."
    )
