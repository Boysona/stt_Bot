    ...
    try:
        ...
        for u in user_cursor:
            ...
            try:
                ...
                logging.warning(f"Skipping user id that cannot be converted to int: {repr(uid_val)}")
                continue
        ...
        for g in group_cursor:
            ...
            try:
                ...
                logging.warning(f"Skipping group id that cannot be converted to int: {repr(gid_val)}")
                continue
