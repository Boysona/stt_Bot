        ...
        def do_translate(chat_id, orig_message_id, progress_message_id):
            try:
                ...
                if len(translated) > 4000:
                    ...
                    bot.send_document(chat_id, f, caption=f"🌍 Translation to {target_lang_name}:", reply_to_message_id=orig_message_id)
                else:
                    bot.send_message(chat_id, f"🌍 Translation to {target_lang_name}:\n\n{translated}", reply_to_message_id=orig_message_id)
            except Exception as e:
        ...
        def do_summarize(chat_id, orig_message_id, progress_message_id):
            try:
                ...
                if len(summary) > 4000:
                    ...
                    bot.send_document(chat_id, f, caption=f"📝 Summary in {target_lang_name}:", reply_to_message_id=orig_message_id)
                else:
                    bot.send_message(chat_id, f"📝 Summary in {target_lang_name}:\n\n{summary}", reply_to_message_id=orig_message_id)
            except Exception as e:
